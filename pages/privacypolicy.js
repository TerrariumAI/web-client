...
let PrivacyPolicy = ({ firebase, router }) => {
  ...
  return (
    <Grid container>
      <Container component="main" maxWidth="md">
        ...
        <Typography>
          Thank you for choosing to be part of our community at Terrarium AI. 
          We are committed to protecting your personal information and your right to privacy. 
          If you have any questions or concerns about our notice, or our practices with regards to your personal information, please contact us at zac@appdojo.com. 
        </Typography>

        <br />

        <Typography>
          When you visit our AI focused service and website https://terrarium.ai, and use our services, you trust us with your personal information. 
          We take your privacy very seriously. In this privacy notice, we describe our privacy notice. 
        ...
        <Typography>
          This privacy notice applies to all information collected through our website (such as https://terrarium.ai), and/or any related services, sales, marketing or events (we refer to them collectively in this privacy notice as the "Services").
        </Typography>
        ...
        <Typography>
          ...
          <ul>
            ...
            <li>
              <b>To enable user-to-user communications.</b> We may use your information in order to enable user-to-user communications with each user's consent. We may use and store this information in aggregated and anonymized form so that it is not associated with individual end users and does not include personal information. We will not use identifiable personal information without your consent.
            </li>
          </ul> 
        </Typography>
        ...
        <Typography>
          <b>In Short:</b><i>We only share information with your consent, to comply with laws, to provide you with services, to protect your rights, or to fulfill business obligations. 
          Your information will never be shared with any other organizations unless they too agree to keep your information private. 
          This use case is for tools that help us collect feedback from you, our user base. 
          It will never be shared or sold to advertisement companies. </i>
          ...
          <ul>
            <li>
              ...
              We may allow selected third parties to use tracking technology on the Services, which will enable them to collect data about how you interact with the Services over time. 
        ...
        <Typography>
          We only use cookies and similar tracking technologies to store your login session on our website.
        </Typography>
        ...
        <Typography variant="h5">
          <b>11. DO WE MAKE UPDATES TO THIS POLICY?</b>
        </Typography>
        <Typography>
        ...
        <Typography variant="h5">
          <b>12. HOW CAN YOU CONTACT US ABOUT THIS POLICY?</b>
        </Typography>
        <Typography>
          If you have questions or comments about this policy, you may email us at zacharyholland@gmail.com
        </Typography>
